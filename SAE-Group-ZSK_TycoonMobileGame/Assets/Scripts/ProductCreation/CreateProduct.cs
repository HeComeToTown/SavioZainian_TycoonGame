...
{
    /// <summary>
    /// This script is for the actual creating of the product
    /// </summary>
    ...
    public void CreateAProduct()
    {
        ...
        //This is for the container prefab's location on the canvas that will have a set location and 
        // add another product beneath it.
